...
namespace OpenRA.Mods.Swp.Traits
{
	...
	public class ProximityCapturableSwpInfo : TraitInfo, IRulesetLoaded, Requires<CargoInfo>
	{
		...
		public void RulesetLoaded(Ruleset rules, ActorInfo info)
		{
			...
			if (pci == null)
				throw new YamlException("ProximityCapturableSwp requires the `Player` actor to have the ProximityCaptor trait.");
		}

		public override object Create(ActorInitializer init) { return new ProximityCapturableSwp(init.Self, this); }
	}

	public class ProximityCapturableSwp : ITick, INotifyAddedToWorld, INotifyRemovedFromWorld, INotifyOwnerChanged
	{
		readonly Cargo cargo;
		public readonly Player OriginalOwner;
		public bool Captured { get { return Self.Owner != OriginalOwner; } }

		public ProximityCapturableSwpInfo Info;
		public Actor Self;
		...
		public ProximityCapturableSwp(Actor self, ProximityCapturableSwpInfo info)
		{
			Info = info;
			Self = self;
