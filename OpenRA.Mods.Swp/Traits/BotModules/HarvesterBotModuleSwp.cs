...
namespace OpenRA.Mods.Swp.Traits
{
	...
	public class HarvesterBotModuleSwpInfo : ConditionalTraitInfo, NotBefore<IResourceLayerInfo>
	{
		...
		public override object Create(ActorInitializer init) { return new HarvesterBotModuleSwp(init.Self, this); }
	}

	public class HarvesterBotModuleSwp : ConditionalTrait<HarvesterBotModuleSwpInfo>, IBotTick, INotifyActorDisposing, IWorldLoaded
	{
		...
		public HarvesterBotModuleSwp(Actor self, HarvesterBotModuleSwpInfo info)
			: base(info)
		{
			world = self.World;
			player = self.Owner;
