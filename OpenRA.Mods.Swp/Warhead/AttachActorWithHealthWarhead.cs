...
namespace OpenRA.Mods.Swp.Warheads
{
	...
	public class AttachActorWithHealthWarhead : WarheadAS
	{
		...
		public override void DoImpact(in Target target, WarheadArgs args)
		{
			...
			foreach (var actor in availableActors)
			{
				...
				actorToAttach.InflictDamage(firedBy, new Damage(actorToAttach.Trait<IHealth>().HP - firedBy.Trait<IHealth>().HP));
